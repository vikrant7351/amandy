...
$(window).on('load', function () {
    ...
    if ($('.header.position-fixed').length > 0) {
        $('main').css('padding-top', $('.header').outerHeight() + 15);
        $('.main-container').css('min-height', $(window).height() - header.outerHeight() - 10);
    }
    if (footer.length > 0) {
        $('main').css('padding-bottom', footer.outerHeight() + 10);
    }
    if (footer.length > 0 && $('.header.position-fixed').length > 0) {
        $('.main-container').css('min-height', $(window).height() - header.outerHeight() - footer.outerHeight() - 10);
    }
    if (footerinfo.length > 0 && $('.header.position-fixed').length > 0) {
        $('.main-container').css('min-height', $(window).height() - header.outerHeight() - footerinfo.outerHeight() - 15);
    }
    if (footerinfo.length > 0) {
        $('main').css('min-height', $(window).height() - footerinfo.outerHeight());
    }
